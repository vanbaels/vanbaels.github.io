...
#| warning: false
#| label: fig-ptp_years
#| fig-cap: Price-to-part ratio (in eurocent per piece) of licensed and non-licensed sets from 2018 to 2024.
...
Next, let's focus on how the mean price-to-part ratio (also shown als in @fig-ptp_years as black dots) evolves over the years for both licensed and non-licensed sets:
...
#| fig-cap: Evolution of the mean price-to-part ratio (in eurocent) from 2018 to 2024.
