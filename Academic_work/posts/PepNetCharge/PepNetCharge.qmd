...
This post starts with an introduction on how all the formulas for charge calculation were derived. If you want to go directly to writing the function in `R`, that starts in @sec-writing-the-r-function
...
## Writing the `R` function {#sec-writing-the-r-function}
