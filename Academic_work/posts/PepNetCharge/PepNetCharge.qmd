...
This post starts with a quite extensive introduction on how all the formulas for the charge calculations were derived. If you want to see the `R` code directly, go to @sec-writing-the-r-function.
